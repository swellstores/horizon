...
import QuizResultsCart from './QuizResultsCart';

export default {
  title: 'Molecules/QuizResultsCart',
  component: QuizResultsCart,
  argTypes: {
    resultsGroups: { control: 'array' },
  },
} as ComponentMeta<typeof QuizResultsCart>;

const Template: ComponentStory<typeof QuizResultsCart> = (args) => (
  <QuizResultsCart {...args} />
);
